...
public class Main {
    public static void main(String[] args) {
        Employee human1 = new Employee("Sergey", "Arlashkin", "Aleksandrovich", "Technical Director",
                "sergey_arlash@mail.ru", 89273604420L, 99999, 1985);
